...
| `spot_instance`                                                                                                                                                              | Optional. Default is false.                | Specifies Use spot instance or not.                                                                                                                                                                                                                                                                                                   |
| `spot_instance_price`                                                                                                                                                        | Optional. Default is 0.07.                 | Specifies Price of your spot instance. Default to be a bit higher than avg of ap-northeast-1 t3.xlarge price at 2021/11                                                                                                                                                                                                               |
